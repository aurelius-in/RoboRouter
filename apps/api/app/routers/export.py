...
@router.post("/export")
def export_artifact(scene_id: uuid.UUID, type: str, crs: str = "EPSG:3857", draco: bool = False, simplify: float = 0.0) -> Dict[str, Any]:  # type: ignore[no-untyped-def]
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            if type.lower() == "potree":
                ...
                export_gltf(input_laz, out_gltf, draco=bool(draco), simplify=float(simplify))
